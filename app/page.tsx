...
import { StickyScene } from "@/components/sticky-scene";
      ...
      <section className="relative">
        ...
        >
          <div className="sticky-stage relative flex min-h-screen flex-col justify-between">
            ...
            <div className="masthead-enter sticky-copy flex items-center justify-between gap-6 border-b border-white/10 pb-5 text-[0.7rem] uppercase tracking-[0.32em] text-white/46">
              <span>Eric S.</span>
            ...
            <div className="grid flex-1 gap-16 py-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(340px,0.8fr)] lg:items-center">
              <div className="sticky-panel-left max-w-4xl">
              ...
              <div className="sticky-panel-right">
                <div
                ...
                >
                  ...
                  <div className="hero-panel-content">
                    ...
                    <div className={`${ruleClass} sticky-divider`} />
          ...
          <div className="sticky-stage w-full">
            <Reveal className={cardClass}>
              <div className="grid gap-10 lg:grid-cols-[minmax(220px,0.7fr)_minmax(0,1.3fr)] lg:items-start">
                <div className="sticky-panel-left max-w-sm">
                ...
                <div className="sticky-panel-right space-y-8">
      ...
      <section id="services" className="scroll-mt-20">
        ...
        >
          <div className="sticky-stage w-full">
            ...
            <div className="sticky-grid mt-12 grid gap-6 lg:grid-cols-3">
              {offerings.map((offering, index) => (
                <Reveal
                  key={offering.name}
                  delay={index * 120}
                  className="h-full sticky-card"
                  style={
                    {
                      "--sticky-card-shift": `${22 + index * 12}px`,
                    } as CSSProperties
                  }
                >
                  <article
          ...
          <div className="sticky-stage w-full">
            <Reveal className={cardClass}>
              <div className="grid gap-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
                <div className="sticky-panel-left max-w-lg">
